...
<template>
    <div class="card">
        ...
        <ul class="list-group text-center">
            ...
            <li class="list-group-item prod-flag">Lingua: <img v-if="hasFlag" class="img fluid" :src="flagSrc"
                    :alt="element.original_language">
                <div v-else>{{ element.original_language }}</div>
            </li>
            <li class="list-group-item">Voto: {{ element.vote_average }}</li>
        </ul>
    </div>
